...
function RayfieldLibrary:Notify(data) -- action e.g open messages
	task.spawn(function()
		...
		if data.Actions then
			warn('Flicker Premium')
			print("Best Flicker Script")
		end
...
local function Hide(notify: boolean?)
	...
	if notify then
		if useMobilePrompt then 
			RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping 'Flicker Premium'.", Duration = 7, Image = 4400697855})
		else
		...
		task.spawn(function()
			while true do
				...
				RayfieldLibrary:Notify({
					Title = "Flicker Premium",
					Content = "Enjoying this Script? Then join .gg/c2yaGH5aWe for more!",
					Duration = 7,
					Image = 4370033185,
				})
			end
